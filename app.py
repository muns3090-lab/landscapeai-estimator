...
1. **PROJECT FEASIBILITY** - Is the budget realistic? What is achievable?
...
with col_right:
    ...
    st.markdown('<div class="section-card"><div class="section-title">✨ Step 5 — Features and Add-ons</div>', unsafe_allow_html=True)
